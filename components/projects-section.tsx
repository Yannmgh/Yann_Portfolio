  ...
  const projects = [
    {
      title: "MSA Mapping",
      description:
        "Full-stack web application designed to streamline the connection between missions and freelance technicians. Features interactive mapping for geolocation-based assignment.",
      stack: ["Next.js", "TypeScript", "Tailwind CSS", "Node.js", "Express", "Leaflet.js"],
      image: "/msa-mapping-dashboard.jpg",
      github: "https://github.com/Yannmgh/MSA_mapping_Projet",
    },
    {
      title: "Velib Paris",
      description:
        "Web application to visualize and manage (edit, create, delete) Velib bike stations around a given position in Paris on a Mapbox map background.",
      stack: ["React", "JavaScript", "Python", "Flask", "SQLite", "Mapbox"],
      image: "/velib-paris-app.jpg",
      github: "https://github.com/Yannmgh/Velib_Paris",
    },
    {
      title: "CV Extractor",
      description:
        "Full-stack Python application for automatically extracting information from CVs (PDF or DOCX) without using AI. Extraction is done via regular expressions and document parsing.",
      stack: ["Python", "Flask", "RegEx", "PDF Parsing"],
      image: "/cv-extractor-app.jpg",
      github: "https://github.com/Yannmgh/Test_technique_CBX_Group",
    },
    {
      title: "RetinaML",
      description:
